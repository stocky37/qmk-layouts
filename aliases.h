...
#define _________________QWERTY_L2_________________       SYM(KC_A), KC_S,    KC_D,    KC_F,    KC_G
#define _________________QWERTY_L3_________________       KC_Z,      KC_X,    KC_C,    KC_V,    KC_B

#define _________________QWERTY_R1_________________       KC_Y,    KC_U,    KC_I,    KC_O,    KC_P
#define _________________QWERTY_R2_________________       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, SYM(KC_QUOT)
#define _________________QWERTY_R3_________________       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH

#define _________________UCIEA_L1__________________       KC_P,      KC_Y,    KC_U,    KC_O,    KC_MINS
#define _________________UCIEA_L2__________________       SYM(KC_C), KC_I,    KC_E,    KC_A,    KC_QUOT
...
#define _________________UCIEA_R2__________________       KC_G,    KC_T,    KC_N,    KC_S,    KC_R,    SYM(KC_V)
...
#define _______________UCIEA_GCSV_L2_______________       SYM(KC_C), KC_I,    KC_E,    KC_A,    KC_COMM
...
#define _______________UCIEA_GCSV_R2_______________       KC_D,    KC_T,    KC_R,    KC_N,    KC_S,    SYM(KC_V)
...
#define _________________ENGRAM_R2_________________       KC_DOT,  KC_H,    KC_T,    KC_S,    KC_N,    SYM(KC_Q)
